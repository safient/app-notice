  ...
  return (
    <div class='px-4 py-5 mx-auto sm:max-w-xl md:max-w-full  md:px-24 lg:px-30  sticky top-0 z-50 text-white'>
      <div class='relative flex items-center justify-between lg:pl-16 lg:mt-10'>
        <img src='/safexLogo.png' alt='logo' width='100px' />
        <ul class='flex items-center hidden space-x-8 lg:flex'>
          ...
          <li>
            <a
              ...
              class='inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-gray-100 hover:text-gray-900 focus:shadow-outline focus:outline-none border border-gray-100'
              aria-label='Sign up'
              title='Sign up'
            >
              App
